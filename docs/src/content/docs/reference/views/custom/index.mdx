...
In order to have a custom view that uses the same layout as the rest of your backoffice, you will can wrap your component like this:
...
Note that the `currentView` should be the name of the view you added on the backend side (in the sidebar this will allow to highlight the current opened view).
