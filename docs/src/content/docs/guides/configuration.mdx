...
Now That Adomin is installed and ready, if not, start [here](/guides/installation), let's add some basic configuration:
...
If you did not setup adomin frontend yet, <a href="/guides/installation#frontend-installation">go here</a>
...
In a real application, your Back-office might have many pages with complex configurations, to learn what you can do with Adomin see [the reference pages for models views](/reference/views)
